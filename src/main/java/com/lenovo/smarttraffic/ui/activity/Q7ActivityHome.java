...
public class Q7ActivityHome extends BaseActivity implements MyCallBack {
    ...
    private void getMsg(){
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                OkHttpUtil.doPost("GetAllSense.do", hashMap, AllSenseResultBean.class, Q7ActivityHome.this, 1);
            }
        }, 0, 10000);
