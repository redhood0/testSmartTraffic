...
import com.lenovo.smarttraffic.bean.Q10DialogBean;
...
public class Q10Activity extends BaseActivity implements MyCallBack {
    Timer timer;
    ...
    private void doPost() {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                OkHttpUtil.doPost("GetBusStationInfo.do",req1, GetBusStationInfoResult.class,Q10Activity.this,1);

                HashMap<String,String> req2 = new HashMap<>();
                req2.put("BusStationId","2");
                req2.put("UserName","user1");
                OkHttpUtil.doPost("GetBusStationInfo.do",req2, GetBusStationInfoResult.class,Q10Activity.this,2);
